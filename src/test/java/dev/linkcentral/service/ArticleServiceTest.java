...
public class ArticleServiceTest {
    ...
    void save_article() {
        ...
        // given
        ArticleRequestDTO articleDTO = new ArticleRequestDTO(null, "제목", "작성자", null);
    ...
    void find_all_articles() {
        ...
        // when
        List<ArticleRequestDTO> foundArticles = articleService.findAll();
    ...
    void find_article_by_id() {
        ...
        // when
        ArticleRequestDTO foundArticle = articleService.findById(articleId, member);
    ...
    void update_article() {
        ...
        // given
        ArticleUpdateRequestDTO updateDTO = new ArticleUpdateRequestDTO(1L, "작성자", "수정된 제목", "수정된 내용");
        ...
        // when
        ArticleRequestDTO updatedArticle = articleService.update(updateDTO);
    ...
    void get_paged_articles() {
        ...
        // when
        Page<ArticleRequestDTO> pageResult = articleService.paging(pageable);
    ...
    void toggle_like_when_like_exists() {
        ...
        // when
        articleService.toggleLike(articleId, member);
    ...
    void get_article_likes_count() {
        ...
        // when
        int likesCount = articleService.getLikesCount(articleId);
